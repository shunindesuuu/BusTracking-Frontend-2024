...
const SideBarDriver = () => {
  ...
  const fetchBus = async () => {
    try {
      const response = await fetch(`https://54.253.121.220:4000/buses/driver/${userId}`);
      if (!response.ok) {
      ...
      const passengerResponse = await fetch(`https://54.253.121.220:4000/thingspeak/bus-passenger/${result.id}`);
